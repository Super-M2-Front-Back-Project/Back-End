...
router.get('/', optionalAuth, asyncHandler(async (req, res) => {
    ...
    const result = await productsGetController(page, limit, search, category_id, vendor_id, min_price, max_price, sort_by, order);
...
router.get('/search', asyncHandler(async (req, res) => {
    ...
    const result = await productsSearchController(searchTerm);
...
router.get('/:id', asyncHandler(async (req, res) => {
    ...
    const result = await productsGetByIdController(id);
...
router.post('/', authenticate, authorize('VENDEUR', 'ADMIN'), asyncHandler(async (req, res) => {
    ...
    const product = await productsPostController(nom, description, prix, stock, image_url, categorie_id, vendeur.id);
